...
public class EmailGeneratorService {
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate a professional email replay for the following email content. Please don't generate a subject line. Generate only an single response ");
        if (emailRequest.getTone() != null
                && emailRequest.getEmailContent() != null
                && !emailRequest.getEmailContent().isEmpty()) {
